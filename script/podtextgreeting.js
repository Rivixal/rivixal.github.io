var texts = [
    "Добро пожаловать на сайт Maydilsiel! Здесь вы найдете наши проекты.",
    "Если вы ищете решения для своих проблем, у нас также есть гайды, которые помогут вам.",
    "В нашем 'Web-APP' вы найдете самые необходимые приложения, а скоро мы добавим еще развлечения.",
    ...
    "В разделе 'Файлы' вы найдете все программы, использованные в наших видео.",
